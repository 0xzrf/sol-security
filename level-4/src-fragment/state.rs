...
pub struct Escrow {
    ...
    pub mint: Pubkey,
    pub amount: u64, // Amount staked in place
    pub withdrawal: u64,
    pub start_time: u64,
    pub end_time: u64,
    pub interval: u64,
...
// For maxing nr_intervals::
// Time -> maximize === end_time maximize
// self.interval has to be least
// start time has to be least

// for maximizing interval_amount:::
// amount -> Maximize
// duration has to be least === end_time - start_time has to be least


// Conclusions:
// Interval doesn't even matter